 ...
 */
export declare function autoImportSettings(outputChannel: vscode.OutputChannel, { providerSettingsManager, contextProxy, customModesManager }: ImportOptions): Promise<void>;
