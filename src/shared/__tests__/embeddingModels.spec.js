...
import { getModelDimension, getModelScoreThreshold, getDefaultModelId, EMBEDDING_MODEL_PROFILES, } from "../embeddingModels";
describe("embeddingModels", () => {
    ...
    describe("getModelDimension", () => {
        ...
        it("should return undefined for unknown provider", () => {
            const dimension = getModelDimension("unknown-provider", "some-model");
            expect(dimension).toBeUndefined();
        });
