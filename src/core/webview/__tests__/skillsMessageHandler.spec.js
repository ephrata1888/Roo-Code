...
import { handleRequestSkills, handleCreateSkill, handleDeleteSkill, handleMoveSkill, handleOpenSkillFile, } from "../skillsMessageHandler";
describe("skillsMessageHandler", () => {
    ...
    describe("handleCreateSkill", () => {
        ...
        it("returns undefined when required fields are missing", async () => {
            ...
            expect(mockLog).toHaveBeenCalledWith("Error creating skill: Missing required fields: skillName, source, or skillDescription");
            expect(vscode.window.showErrorMessage).toHaveBeenCalledWith("Failed to create skill: Missing required fields: skillName, source, or skillDescription");
        });
        it("returns undefined when skills manager is not available", async () => {
            ...
            expect(vscode.window.showErrorMessage).toHaveBeenCalledWith("Failed to create skill: Skills manager not available");
        });
    });
    describe("handleDeleteSkill", () => {
        ...
        it("returns undefined when required fields are missing", async () => {
            ...
            expect(vscode.window.showErrorMessage).toHaveBeenCalledWith("Failed to delete skill: Missing required fields: skillName or source");
        });
        it("returns undefined when skills manager is not available", async () => {
            const provider = createMockProvider(false);
            const result = await handleDeleteSkill(provider, {
            ...
            expect(vscode.window.showErrorMessage).toHaveBeenCalledWith("Failed to delete skill: Skills manager not available");
        });
    });
    describe("handleMoveSkill", () => {
        ...
        it("returns undefined when required fields are missing", async () => {
            ...
            expect(vscode.window.showErrorMessage).toHaveBeenCalledWith("Failed to move skill: Missing required fields: skillName or source");
        });
        it("returns undefined when skills manager is not available", async () => {
            const provider = createMockProvider(false);
            const result = await handleMoveSkill(provider, {
            ...
            expect(vscode.window.showErrorMessage).toHaveBeenCalledWith("Failed to move skill: Skills manager not available");
        });
    });
    describe("handleOpenSkillFile", () => {
        ...
        it("shows error when required fields are missing", async () => {
            ...
            expect(mockLog).toHaveBeenCalledWith("Error opening skill file: Missing required fields: skillName or source");
            expect(vscode.window.showErrorMessage).toHaveBeenCalledWith("Failed to open skill file: Missing required fields: skillName or source");
        });
        it("shows error when skills manager is not available", async () => {
            ...
            expect(vscode.window.showErrorMessage).toHaveBeenCalledWith("Failed to open skill file: Skills manager not available");
        });
        it("shows error when skill is not found", async () => {
            ...
            expect(vscode.window.showErrorMessage).toHaveBeenCalledWith('Failed to open skill file: Skill "nonexistent-skill" not found');
        });
    });
});
