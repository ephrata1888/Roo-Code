 ...
 */
export async function handleRequestSkills(provider) {
    try {
 ...
 */
export async function handleCreateSkill(provider, message) {
    try {
 ...
 */
export async function handleDeleteSkill(provider, message) {
    try {
        const skillName = message.skillName;
        const source = message.source;
 ...
 */
export async function handleMoveSkill(provider, message) {
    try {
        const skillName = message.skillName;
        const source = message.source;
 ...
 */
export async function handleUpdateSkillModes(provider, message) {
    try {
        const skillName = message.skillName;
        const source = message.source;
 ...
 */
export async function handleOpenSkillFile(provider, message) {
    try {
        const skillName = message.skillName;
        const source = message.source;
        if (!skillName || !source) {
