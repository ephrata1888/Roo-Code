...
import { PROVIDER_SETTINGS_KEYS, GLOBAL_SETTINGS_KEYS, SECRET_STATE_KEYS, GLOBAL_STATE_KEYS, GLOBAL_SECRET_KEYS, providerSettingsSchema, globalSettingsSchema, isSecretStateKey, isProviderName, isRetiredProvider, } from "@roo-code/types";
...
export class ContextProxy {
    ...
    async migrateInvalidApiProvider() {
        try {
            ...
            const isKnownProvider = typeof apiProvider === "string" && (isProviderName(apiProvider) || isRetiredProvider(apiProvider));
    ...
    sanitizeProviderValues(values) {
        ...
        const isKnownProvider = typeof values.apiProvider === "string" &&
