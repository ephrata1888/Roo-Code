...
export declare const providerProfilesSchema: z.ZodObject<{
    ...
    apiConfigs: z.ZodRecord<z.ZodString, z.ZodObject<{
        ...
        openAiCustomModelInfo: z.ZodOptional<z.ZodNullable<z.ZodObject<{
            ...
            supportsReasoningEffort: z.ZodOptional<z.ZodUnion<[z.ZodBoolean, z.ZodArray<z.ZodEnum<["disable", "none", "minimal", "low", "medium", "high", "xhigh"]>, "many">]>>;
        ...
        apiProvider: z.ZodOptional<z.ZodUnion<[z.ZodEnum<["openrouter", "vercel-ai-gateway", "litellm", "requesty", "roo", "ollama", "lmstudio", "vscode-lm", "openai", "fake-ai", "anthropic", "bedrock", "baseten", "deepseek", "fireworks", "gemini", "gemini-cli", "mistral", "moonshot", "minimax", "openai-codex", "openai-native", "qwen-code", "roo", "sambanova", "vertex", "xai", "zai"]>, z.ZodEnum<["cerebras", "chutes", "deepinfra", "doubao", "featherless", "groq", "huggingface", "io-intelligence", "unbound"]>]>>;
    } & {
        id: z.ZodOptional<z.ZodString>;
    }, "strip", z.ZodTypeAny, {
        id?: string | undefined;
