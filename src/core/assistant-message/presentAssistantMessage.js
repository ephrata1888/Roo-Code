        ...
        case "tool_use": {
            ...
            if (!block.partial) {
                ...
                try {
                    ...
                    validateToolUse(block.name, mode ?? defaultModeSlug, customModes ?? [], toolRequirements, block.params, stateExperiments, includedTools);
                }
                catch (error) {
                    cline.consecutiveMistakeCount++;
            ...
            const hookEngine = new HookEngine(new PreHook(intentService), new PostHook());
            switch (block.name) {
                case "write_to_file":
                    await hookEngine.interceptToolCall("write_to_file", block, async () => {
                ...
                case "search_and_replace":
                    await checkpointSaveAndMark(cline);
                    await editTool.handle(cline, block, {
                        askApproval,
                        handleError,
                        pushToolResult,
                    });
                ...
                case "search_files":
                    ...
                    break;
                case "execute_command":
                    await hookEngine.interceptToolCall("execute_command", block, async () => {
                    ...
                    break;
                case "read_command_output":
                    await readCommandOutputTool.handle(cline, block, {
                        askApproval,
                        handleError,
                        pushToolResult,
                    });
                ...
                case "run_slash_command":
                    ...
                    break;
                case "skill":
                    await skillTool.handle(cline, block, {
                        askApproval,
                        handleError,
                        pushToolResult,
                    });
