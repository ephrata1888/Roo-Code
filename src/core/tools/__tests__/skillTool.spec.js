...
describe("skillTool", () => {
    ...
    it("should handle missing skill parameter", async () => {
        ...
        await skillTool.handle(mockTask, block, mockCallbacks);
    ...
    it("should handle skill not found", async () => {
        ...
        await skillTool.handle(mockTask, block, mockCallbacks);
        expect(mockCallbacks.pushToolResult).toHaveBeenCalledWith(formatResponse.toolError("Skill 'non-existent' not found. Available skills: create-mcp-server"));
    });
    it("should handle empty available skills list", async () => {
        ...
        await skillTool.handle(mockTask, block, mockCallbacks);
        expect(mockCallbacks.pushToolResult).toHaveBeenCalledWith(formatResponse.toolError("Skill 'non-existent' not found. Available skills: (none)"));
    });
    it("should successfully load a global skill", async () => {
        ...
        expect(mockCallbacks.pushToolResult).toHaveBeenCalledWith(`Skill: create-mcp-server
Description: Instructions for creating MCP servers
Source: global
...
Step 1: Create the server...`);
    ...
    it("should handle Skills Manager not available", async () => {
        ...
        await skillTool.handle(mockTask, block, mockCallbacks);
        expect(mockTask.recordToolError).toHaveBeenCalledWith("skill");
        expect(mockCallbacks.pushToolResult).toHaveBeenCalledWith(formatResponse.toolError("Skills Manager not available"));
    });
    it("should load project skill", async () => {
        ...
        expect(mockCallbacks.pushToolResult).toHaveBeenCalledWith(`Skill: my-project-skill
Description: A custom project skill
Source: project
