...
describe("mode-validator", () => {
    ...
    describe("validateToolUse", () => {
        ...
        it("blocks tool when disabledTools is converted to toolRequirements", () => {
            ...
            expect(() => validateToolUse("execute_command", codeMode, [], toolRequirements)).toThrow('Tool "execute_command" is not allowed in code mode.');
            expect(() => validateToolUse("search_files", codeMode, [], toolRequirements)).toThrow('Tool "search_files" is not allowed in code mode.');
        });
