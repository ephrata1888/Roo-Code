...
describe("processUserContentMentions", () => {
    ...
    describe("showRooIgnoredFiles parameter", () => {
        it("should default showRooIgnoredFiles to false", async () => {
            ...
            expect(parseMentions).toHaveBeenCalledWith("<user_message>Test default</user_message>", "/test", mockFileContextTracker, undefined, false, // showRooIgnoredFiles should default to false
        ...
        it("should respect showRooIgnoredFiles when explicitly set to false", async () => {
            ...
            expect(parseMentions).toHaveBeenCalledWith("<user_message>Test explicit false</user_message>", "/test", mockFileContextTracker, undefined, false, true, // includeDiagnosticMessages
            50);
        });
    });
